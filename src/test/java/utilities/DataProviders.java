...
public class DataProviders 
{
	...
	{
		String path=".\\testData\\DemoWebShop_LoginData.xlsx"; //accessing excel file from testData folder
		//OR
		//String path=System.getProperty("user.dir")+"\\testData\\DemoWebShop_LoginData.xlsx";
		...
		//System.out.println("Total Colunms "+totalcols);
